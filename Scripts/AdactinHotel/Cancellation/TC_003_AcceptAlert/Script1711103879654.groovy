...
cancel = WebUI.getText(findTestObject('Cancellation/Page_Adactin.com - Select Hotel/The booking has been cancelled'))

WebUI.verifyEqual(cancel, 'The booking has been cancelled.')
