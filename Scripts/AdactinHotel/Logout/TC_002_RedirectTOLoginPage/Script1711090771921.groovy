...
WebUI.click(findTestObject('Search Hotel/Page_Adactin.com - Search Hotel/a_Logout'))

data2 = WebUI.getText(findTestObject('Search Hotel/Page_Adactin.com - Logout/td_You have successfully logged out. Click here to login again'))

WebUI.verifyEqual(data2, 'You have successfully logged out. Click here to login again')

WebUI.click(findTestObject('LogOut/Page_Adactin.com - Logout/a_Click here to login again'))

loginPageVerify = WebUI.getText(findTestObject('LogOut/Page_Adactin.com - Hotel Reservation System/p_Adactin Launches The Adactin Hotel App'))

WebUI.verifyEqual(loginPageVerify, 'Adactin Launches The Adactin Hotel App!')
