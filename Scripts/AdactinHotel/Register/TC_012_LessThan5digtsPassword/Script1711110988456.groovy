...
WebUI.setText(findTestObject('Register/Page_Adactin.com - New User Registration/input__full_name'), findTestData('AdactinHotelTestData').getValue(
        4, 22))
...
password = WebUI.getText(findTestObject('Register/Page_Adactin.com - New User Registration/label_Password must contain minimum 6 characters'))

WebUI.verifyEqual(password, 'Password must contain minimum 6 characters')

confirmPassword = WebUI.getText(findTestObject('Register/Page_Adactin.com - New User Registration/Passwords Do Not Match'))

WebUI.verifyEqual(confirmPassword, 'Passwords Do Not Match')
