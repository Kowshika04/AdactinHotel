...
userName = WebUI.getText(findTestObject('Register/Page_Adactin.com - New User Registration/label_Username must contain minimum 8 characters'))

WebUI.verifyEqual(userName, 'Username must contain minimum 8 characters')
