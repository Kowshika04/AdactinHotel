...
email = WebUI.getText(findTestObject('Register/Page_Adactin.com - New User Registration/label_Invalid email, Please enter correct email'))

WebUI.verifyEqual(email, 'Invalid email, Please enter correct email.')
