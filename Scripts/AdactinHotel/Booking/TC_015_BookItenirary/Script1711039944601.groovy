...
WebUI.click(findTestObject('Booking/Page_Adactin.com - Book A Hotel/a_Booked Itinerary'))

data4 = WebUI.getText(findTestObject('Booking/Page_Adactin.com - Select Hotel/td_Booked Itinerary'))

WebUI.verifyEqual(data4, 'Booked Itinerary')
