...
data5 = WebUI.getText(findTestObject('Booking/Page_Adactin.com - Book A Hotel/label_Please Enter your 16 Digit Credit Card Number'), 
    FailureHandling.STOP_ON_FAILURE)

WebUI.verifyEqual(data5, 'Please Enter your 16 Digit Credit Card Number')
