...
data2 = WebUI.getText(findTestObject('Booking/Page_Adactin.com - Select Hotel/td_Select Hotel'))
...
WebUI.click(findTestObject('Booking/Page_Adactin.com - Book A Hotel/a_Search Hotel'))

data4 = WebUI.getText(findTestObject('Booking/Page_Adactin.com - Search Hotel/td_Search Hotel (Fields marked with Red asterix () are mandatory)'))

WebUI.verifyEqual(data4, 'Search Hotel (Fields marked with Red asterix (*) are mandatory)')
