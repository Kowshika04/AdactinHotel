...
WebUI.click(findTestObject('Booking/Page_Adactin.com - Book A Hotel/a_Change Password'))

data4 = WebUI.getText(findTestObject('Booking/Page_Adactin.com - Search Hotel/strong_Change Password'))

WebUI.verifyEqual(data4, 'Change Password')
