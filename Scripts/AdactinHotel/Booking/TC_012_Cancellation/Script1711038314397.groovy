...
WebUI.click(findTestObject('Booking/Page_Adactin.com - Book A Hotel/input__cancel'))

data4 = WebUI.getText(findTestObject('Booking/Page_Adactin.com - Select Hotel/td_Select Hotel'))

WebUI.verifyEqual(data4, 'Select Hotel')
