...
WebUI.click(findTestObject('Booking/Page_Adactin.com - Book A Hotel/a_Logout'))

data4 = WebUI.getText(findTestObject('Booking/Page_Adactin.com - Logout/td_You have successfully logged out. Click here to login again'))

WebUI.verifyEqual(data4, 'You have successfully logged out. Click here to login again')
