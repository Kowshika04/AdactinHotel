...
data4 = WebUI.getText(findTestObject('Booking/Page_Adactin.com - Book A Hotel/label_Please Enter your First Name'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyEqual(data4, 'Please Enter your First Name')
