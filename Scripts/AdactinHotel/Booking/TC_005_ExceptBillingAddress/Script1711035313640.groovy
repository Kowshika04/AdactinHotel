...
data4 = WebUI.getText(findTestObject('Booking/Page_Adactin.com - Book A Hotel/label_Please Enter your Address'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyEqual(data4, 'Please Enter your Address')
