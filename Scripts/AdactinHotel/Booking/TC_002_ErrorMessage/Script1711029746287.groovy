...
data3 = WebUI.getText(findTestObject('Booking/Page_Adactin.com - Book A Hotel/label_Please Enter your First Name'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyEqual(data3, 'Please Enter your First Name')

data4 = WebUI.getText(findTestObject('Booking/Page_Adactin.com - Book A Hotel/label_Please Enter you Last Name'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyEqual(data4, 'Please Enter you Last Name')

data5 = WebUI.getText(findTestObject('Booking/Page_Adactin.com - Book A Hotel/label_Please Enter your Address'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyEqual(data5, 'Please Enter your Address')

data6 = WebUI.getText(findTestObject('Booking/Page_Adactin.com - Book A Hotel/label_Please Enter your 16 Digit Credit Card Number'), 
    FailureHandling.STOP_ON_FAILURE)

WebUI.verifyEqual(data6, 'Please Enter your 16 Digit Credit Card Number')

data7 = WebUI.getText(findTestObject('Booking/Page_Adactin.com - Book A Hotel/label_Please Select your Credit Card Type'), 
    FailureHandling.STOP_ON_FAILURE)

WebUI.verifyEqual(data7, 'Please Select your Credit Card Type')

data8 = WebUI.getText(findTestObject('Booking/Page_Adactin.com - Book A Hotel/label_Please Select your Credit Card Expiry Month'), 
    FailureHandling.STOP_ON_FAILURE)

WebUI.verifyEqual(data8, 'Please Select your Credit Card Expiry Month')

data9 = WebUI.getText(findTestObject('Booking/Page_Adactin.com - Book A Hotel/label_Please Enter your Credit Card CVV Number'), 
    FailureHandling.STOP_ON_FAILURE)

WebUI.verifyEqual(data9, 'Please Enter your Credit Card CVV Number')
