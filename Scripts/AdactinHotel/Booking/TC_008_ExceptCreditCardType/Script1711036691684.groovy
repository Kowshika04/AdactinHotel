...
data4 = WebUI.getText(findTestObject('Booking/Page_Adactin.com - Book A Hotel/label_Please Select your Credit Card Type'), 
    FailureHandling.STOP_ON_FAILURE)

WebUI.verifyEqual(data4, 'Please Select your Credit Card Type')
