...
data2 = WebUI.getText(findTestObject('Search Hotel/Page_Adactin.com - Search Hotel/span_Please Select Adults per Room'))

WebUI.verifyEqual(data2, 'Please Select Adults per Room')
