...
WebUI.click(findTestObject('Search Hotel/Page_Adactin.com - Search Hotel/a_Change Password'))

data2 = WebUI.getText(findTestObject('Search Hotel/Page_Adactin.com - Search Hotel/strong_Change Password'))

WebUI.verifyEqual(data2, 'Change Password')
