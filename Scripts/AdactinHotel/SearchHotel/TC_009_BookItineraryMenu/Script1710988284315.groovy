...
WebUI.click(findTestObject('Search Hotel/Page_Adactin.com - Search Hotel/a_Booked Itinerary'))

data2 = WebUI.getText(findTestObject('Search Hotel/Page_Adactin.com - Search Hotel/Page_Adactin.com - Select Hotel/td_Booked Itinerary'))

WebUI.verifyEqual(data2, 'Booked Itinerary')
