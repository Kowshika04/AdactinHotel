...
data2 = WebUI.getText(findTestObject('Search Hotel/Page_Adactin.com - Search Hotel/span_Please Select Check-In Date'))

WebUI.verifyEqual(data2, 'Please Select Check-In Date')
