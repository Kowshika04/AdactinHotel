...
WebUI.click(findTestObject('SelectHotel/Page_Adactin.com - Select Hotel/input_Total Price (excl. GST)_cancel'))

data3 = WebUI.getText(findTestObject('Search Hotel/Page_Adactin.com - Search Hotel/td_Search Hotel (Fields marked with Red asterix () are mandatory)'))

WebUI.verifyEqual(data3, 'Search Hotel (Fields marked with Red asterix (*) are mandatory)')
