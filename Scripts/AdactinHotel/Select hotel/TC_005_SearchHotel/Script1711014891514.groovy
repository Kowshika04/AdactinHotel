...
WebUI.click(findTestObject('SelectHotel/Page_Adactin.com - Select Hotel/a_Search Hotel'))

data3 = WebUI.getText(findTestObject('SelectHotel/Page_Adactin.com - Search Hotel/td_Search Hotel (Fields marked with Red asterix () are mandatory)'))
