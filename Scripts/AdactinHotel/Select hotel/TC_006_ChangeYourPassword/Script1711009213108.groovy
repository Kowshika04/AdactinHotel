...
WebUI.click(findTestObject('SelectHotel/Page_Adactin.com - Select Hotel/a_Change Password'))

data3 = WebUI.getText(findTestObject('SelectHotel/Page_Adactin.com - Search Hotel/strong_Change Password'))

WebUI.verifyEqual(data3, 'Change Password')
